...
public class MultipleDesignatorStatementList extends DesignatorStatementList {

    private DesignatorStatementList DesignatorStatementList;
    private DesignatorStatement DesignatorStatement;

    public MultipleDesignatorStatementList (DesignatorStatementList DesignatorStatementList, DesignatorStatement DesignatorStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleDesignatorStatementList(\n");
