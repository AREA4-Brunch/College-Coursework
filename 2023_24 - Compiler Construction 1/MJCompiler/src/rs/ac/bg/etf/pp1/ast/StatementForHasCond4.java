...
public class StatementForHasCond4 extends Statement {
    ...
    public StatementForHasCond4 (ForLoopStart ForLoopStart, ForLoopConditionBegin ForLoopConditionBegin, CondFact CondFact, ForLoopConditionEnd ForLoopConditionEnd, ForLoopPostStmntBegin ForLoopPostStmntBegin, OptDesignatorStatementList OptDesignatorStatementList, ForLoopPostStmntEnd ForLoopPostStmntEnd, ForLoopBodyBegin ForLoopBodyBegin, Statement Statement, ForLoopBodyEnd ForLoopBodyEnd) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementForHasCond4(\n");
