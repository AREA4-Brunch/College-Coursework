...
public class HasAddopTermList extends AddopTermList {

    private AddopTermList AddopTermList;
    private Addop Addop;
    private Term Term;

    public HasAddopTermList (AddopTermList AddopTermList, Addop Addop, Term Term) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("HasAddopTermList(\n");
