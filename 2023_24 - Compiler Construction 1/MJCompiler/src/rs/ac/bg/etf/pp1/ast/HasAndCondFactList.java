...
public class HasAndCondFactList extends AndCondFactList {

    private AndCondFactList AndCondFactList;
    private CondFact CondFact;

    public HasAndCondFactList (AndCondFactList AndCondFactList, CondFact CondFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("HasAndCondFactList(\n");
