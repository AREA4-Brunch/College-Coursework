...
public class ClassDeclNoExtendsNoStaticVarDecl extends ClassDecl {
    ...
    public ClassDeclNoExtendsNoStaticVarDecl (ClassName ClassName, StaticInitList StaticInitList, ClassDeclSafeVarDeclList ClassDeclSafeVarDeclList, OptClassBody OptClassBody) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclNoExtendsNoStaticVarDecl(\n");
