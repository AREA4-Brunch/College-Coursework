...
public class HasMulopFactorList extends MulopFactorList {

    private MulopFactorList MulopFactorList;
    private Mulop Mulop;
    private Factor Factor;

    public HasMulopFactorList (MulopFactorList MulopFactorList, Mulop Mulop, Factor Factor) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("HasMulopFactorList(\n");
