...
public class ClassDeclNoExtendsStaticVarDecl extends ClassDecl {
    ...
    public ClassDeclNoExtendsStaticVarDecl (ClassName ClassName, SafeStaticVarDeclList SafeStaticVarDeclList, StaticInitList StaticInitList, ClassDeclSafeVarDeclList ClassDeclSafeVarDeclList, OptClassBody OptClassBody) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclNoExtendsStaticVarDecl(\n");
