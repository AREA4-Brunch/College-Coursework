...
public class MultipleVarIdentifier extends VarIdentifiersList {

    private VarIdentifiersList VarIdentifiersList;
    private String identName;

    public MultipleVarIdentifier (VarIdentifiersList VarIdentifiersList, String identName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleVarIdentifier(\n");
