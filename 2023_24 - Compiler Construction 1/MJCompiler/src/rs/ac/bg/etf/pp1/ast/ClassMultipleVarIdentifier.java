...
public class ClassMultipleVarIdentifier extends ClassFieldVarIdentifiersList {

    private ClassFieldVarIdentifiersList ClassFieldVarIdentifiersList;
    private String identName;

    public ClassMultipleVarIdentifier (ClassFieldVarIdentifiersList ClassFieldVarIdentifiersList, String identName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassMultipleVarIdentifier(\n");
