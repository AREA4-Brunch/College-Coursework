...
public class StatementForNoCond1 extends Statement {
    ...
    public StatementForNoCond1 (ForLoopStart ForLoopStart, SafeDesignatorStatementListSemi SafeDesignatorStatementListSemi, ForLoopConditionBegin ForLoopConditionBegin, ForLoopConditionEnd ForLoopConditionEnd, ForLoopPostStmntBegin ForLoopPostStmntBegin, OptDesignatorStatementList OptDesignatorStatementList, ForLoopPostStmntEnd ForLoopPostStmntEnd, ForLoopBodyBegin ForLoopBodyBegin, Statement Statement, ForLoopBodyEnd ForLoopBodyEnd) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("StatementForNoCond1(\n");
