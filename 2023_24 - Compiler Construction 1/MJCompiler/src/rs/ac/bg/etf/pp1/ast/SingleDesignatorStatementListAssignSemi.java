...
public class SingleDesignatorStatementListAssignSemi extends DesignatorStatementListSemi {

    private DesignatorAssign DesignatorAssign;

    public SingleDesignatorStatementListAssignSemi (DesignatorAssign DesignatorAssign) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleDesignatorStatementListAssignSemi(\n");
