...
public class SafeMultipleArrayIdentifier extends SafeVarIdentifiersList {

    private SafeVarIdentifiersList SafeVarIdentifiersList;
    private String identName;

    public SafeMultipleArrayIdentifier (SafeVarIdentifiersList SafeVarIdentifiersList, String identName) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SafeMultipleArrayIdentifier(\n");
