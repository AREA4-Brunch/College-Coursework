...
public class ClassDeclExtendsStaticVarDeclErr extends ClassDecl {
    ...
    public ClassDeclExtendsStaticVarDeclErr (ClassName ClassName, SafeStaticVarDeclList SafeStaticVarDeclList, StaticInitList StaticInitList, ClassDeclSafeVarDeclList ClassDeclSafeVarDeclList, OptClassBody OptClassBody) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclExtendsStaticVarDeclErr(\n");
