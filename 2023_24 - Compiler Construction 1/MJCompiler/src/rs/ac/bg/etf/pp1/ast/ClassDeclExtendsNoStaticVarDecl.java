...
public class ClassDeclExtendsNoStaticVarDecl extends ClassDecl {
    ...
    public ClassDeclExtendsNoStaticVarDecl (ClassName ClassName, Type Type, StaticInitList StaticInitList, ClassDeclSafeVarDeclList ClassDeclSafeVarDeclList, OptClassBody OptClassBody) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassDeclExtendsNoStaticVarDecl(\n");
