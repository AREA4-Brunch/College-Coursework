...
public class TermMulopFactorList extends Term {

    private Factor Factor;
    private MulopFactorList MulopFactorList;

    public TermMulopFactorList (Factor Factor, MulopFactorList MulopFactorList) {
        this.Factor=Factor;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("TermMulopFactorList(\n");
