...
public class SafeVarDeclSuccess extends SafeVarDecl {

    private Type Type;
    private SafeVarIdentifiersList SafeVarIdentifiersList;

    public SafeVarDeclSuccess (Type Type, SafeVarIdentifiersList SafeVarIdentifiersList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SafeVarDeclSuccess(\n");
