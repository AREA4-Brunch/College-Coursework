...
public class ProgramNamespace extends Program {
    ...
    public ProgramNamespace (ProgName ProgName, NamespaceList NamespaceList, DeclList DeclList, MethodDeclList MethodDeclList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgramNamespace(\n");
